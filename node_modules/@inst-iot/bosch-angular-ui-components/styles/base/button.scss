...
$button-primary-border-color--active: $color-blue-dark-matisse;
$button-primary-border-color--disabled: $color-blue-botticelli--pastell;

$button-secondary-text-color: $color-blue-dark-bahama-blue;
$button-secondary-text-color--active:$color-blue-light-lochmara;
$button-secondary-text-color--disabled: $color-gray-silver-sand;
...
$button-secondary-border-color: $color-blue-dark-bahama-blue;
$button-secondary-border-color--active:$color-blue-light-lochmara;
$button-secondary-border-color--disabled: $color-gray-silver-sand;
$button-secondary-border-color--hover: $color-blue-light-lochmara--pastell;
$button-secondary-color--hover: $color-blue-light-lochmara--pastell;
...
.rb-btn {
  ...
  .rb-ic:first-child {
    margin-left: -$button-padding-horizontal--smaller/4;
  }
  .rb-ic:last-child {
    margin-right: -$button-padding-horizontal--smaller/4;
  }
  ...
  &.rb-secondary {
    ...
    &:not(:disabled) {
      ...
      &:focus {
        ...
        outline: none;
        rb-icon {
          fill: $button-secondary-text-color--active;
        }
