import { __decorate, __metadata, __param, __assign, __spread, __extends, __values } from 'tslib';
import { Directive, TemplateRef, ViewChild, ElementRef, ContentChild, HostListener, Component, Optional, Input, NgModule, Renderer2, Output, EventEmitter, ComponentFactoryResolver, ViewContainerRef, Injectable, InjectionToken, ContentChildren, QueryList, forwardRef, ChangeDetectionStrategy, Self, Inject, ChangeDetectorRef, Injector, ComponentRef, ApplicationRef, Attribute, Pipe } from '@angular/core';
import { CommonModule } from '@angular/common';
import { NavigationEnd, Router, ActivatedRoute, RouterModule, ChildrenOutletContexts, RouterOutlet, RouterLinkWithHref, NavigationStart } from '@angular/router';
...
var CUSTOM_VALUE_CONVERTER = new InjectionToken('formInputCustomValueConverter');
...
var FormTextareaComponent = /** @class */ (function (_super) {
    ...
    FormTextareaComponent = FormTextareaComponent_1 = __decorate([
        Component({
            ...
            providers: [{ provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(function () { return FormTextareaComponent_1; }), multi: true }],
            changeDetection: ChangeDetectionStrategy.OnPush
        }),
        __param(2, Optional()), __param(2, Self()), __param(2, Inject(CUSTOM_VALUE_CONVERTER)),
...
var FORM_SELECT_SELECTOR = new InjectionToken('formCustomSelectSelectorSubject');
...
var NumberConverterDirective = /** @class */ (function () {
    ...
    NumberConverterDirective = NumberConverterDirective_1 = __decorate([
        Directive({
            ...
            providers: [{ provide: CUSTOM_VALUE_CONVERTER, useExisting: forwardRef(function () { return NumberConverterDirective_1; }) }]
        })
...
var TAB_PANEL_RESOLVER = new InjectionToken('TabPanelResolver');
/**
...
var ERROR_FORMATTER = new InjectionToken('rbErrorFormatter');
...
var FLATPICKR_DEFAULT_OPTIONS = new InjectionToken('flatpickrDefaultOptions');
...
var TIME_INPUT_OPTIONS = new InjectionToken('formRelativeInputTimeOptions');
